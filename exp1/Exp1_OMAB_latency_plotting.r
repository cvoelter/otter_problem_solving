...
plot(
  x = xdata$Trial, y = xdata$Latency, las = 1, xlab = "", ylab = "Latency (in s)", xaxt = "n",
  type = "b", pch = c(1, 8, 17)[as.numeric(xdata$Method)], main = "Blacky", ylim = range(1:100), lty = 3
)
...
legend("topleft", c("lid", "stick", "swing"),
  pch = c(1, 8, 17),
  bty = "n", cex = 1.1
)
...
plot(
  x = xdata$Trial, y = xdata$Latency, las = 1, xlab = "", ylab = "", xaxt = "n",
  type = "b", pch = c(1, 8, 17)[as.numeric(xdata$Method)], main = "James", ylim = range(1:100), lty = 3
)
...
plot(
  x = xdata$Trial, y = xdata$Latency, las = 1, xlab = "", ylab = "Latency (in s)", xaxt = "n",
  type = "b", pch = c(1, 8, 17)[as.numeric(xdata$Method)], main = "Rudi", ylim = range(1:100), lty = 3
)
...
plot(
  x = xdata$Trial, y = xdata$Latency, las = 1, xlab = "", ylab = "", xaxt = "n",
  type = "b", pch = c(1, 8, 17)[as.numeric(xdata$Method)], main = "Twoface", ylim = range(1:100), lty = 3
)
